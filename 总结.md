...
MICRO 模型中，我们设计了一种新颖的模态感知结构学习模块，它学习每种模态的项目-项目关系。基于学习到的模态感知潜在项目关系，我们执行图卷积，将项目亲和力显式注入到模态感知项目表示中。此外，我们设计了一种新颖的多模态对比框架，通过强制模态感知表示和多模态融合表示接近来促进细粒度多模态融合。最后，这些丰富的项目表示可以插入现有的协同过滤方法中，以做出更准确的推荐。  
我们提出的 MICRO 模型的总体框架。首先，我们开发了一种新颖的模态感知结构学习层，以从多模态特征中挖掘模态感知的潜在项目-项目语义关系。其次，我们在学习到的模态感知图上采用图卷积来分别显式地建模每种模态的项目关系。第三，我们设计了一种新颖的对比多模态融合框架，以迫使融合的多模态表示以自我监督的方式自适应地捕获多种模态之间共享的项目关系。最后，生成的项目表示形式会融入多种模式的项目关系，这些关系将被添加到 CF 模型的输出项目嵌入中以进行推荐。对比损失和推荐（BPR）损失将一起优化。  
<img src="https://github.com/NanGongNingYi/-/assets/61775768/89f3e31d-1fd1-402c-a7ea-60acca4cb5a9" width="70%">

考虑到各个特定用户群体之间偏好的差异HCGCN


受最近预训练模型成功的启发，PMGT 、BGCN
